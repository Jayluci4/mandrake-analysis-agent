...
def search_google(query: str, num_results: int = 3, language: str = "en") -> list[dict]:
    ...
    try:
        ...
        # Fixed: googlesearch uses 'num' not 'num_results'
        # When advanced is not used, res is just a URL string
        for url in search(search_query, num=num_results, lang=language, pause=2.0):
