...
def get_gene_coding_sequence(gene_name: str, organism: str, email: str = "contact@mandrakebioworks.com") -> list[dict[str, str]]:
    """Retrieves the coding sequence(s) of a specified gene from NCBI Entrez.

    Args:
        gene_name: Name of the gene
        organism: Name of the organism
        email: Email address for NCBI Entrez (defaults to contact@mandrakebioworks.com)
    ...
    """
    # Always set email for NCBI compliance
    Entrez.email = email if email else "contact@mandrakebioworks.com"
    ...
    def search_gene() -> str:
        ...
        try:
            ...
            raise ValueError(f"Failed to search NCBI for gene '{gene_name}': {str(e)}")
