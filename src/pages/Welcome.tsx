      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-extralight mb-6 leading-tight">
            We're <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-teal-400 to-blue-500">
              revolutionizing
            </span>
            <br />
            biomedical research with AI
          </h1>
          
          <p className="text-xl text-gray-400 max-w-3xl mx-auto font-light leading-relaxed">
            Choose your AI-powered research assistant to accelerate discovery, 
